...
/**
 * @brief LMKInit Initialize LMK
 */
void LMKInit(void);

/**
 * @brief LMKSetInput Set clock input
 * @param no Number of input 0 or 1
 */
void LMKSetInput(uint8_t no);

/**
 * @brief LMKSetDiv Set clock divider
 * @param div /2 divider, i.e  1 means 2, 2 means 4, etc.
 */
void LMKSetDiv(uint8_t div);


/**
 * @brief LMKEnable External clock input enable/disable
 * @param en
 */
